...
function Contact() {
  ...
  return (
    <main id="contact" className="container mx-auto max-width section">
      ...
      <h3 className="text-center text-3xl md:text-4xl lg:text-3xl text-gradient font-semibold md:font-bold pt-5 md:pt-10 md:pb-6">
        <a href={`mailto:${email}`}>{email}</a>
      </h3>
      <span className="text-center text-content text-xl font-light block">or</span>
      <h3 className="text-center text-3xl md:text-4xl lg:text-3xl text-gradient font-semibold md:font-bold pt-2 md:py-6">
